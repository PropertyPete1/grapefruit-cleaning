...
function StaffShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-muted/30">
      ...
      <main className="min-w-0 flex-1 px-[calc(1rem+env(safe-area-inset-left))] pb-[calc(4rem+env(safe-area-inset-bottom))] pt-[calc(5rem+env(safe-area-inset-top))] lg:ml-60 lg:px-10 lg:pb-16 lg:pt-10">
        {children}
      </main>
    </div>
  );

...
export default function Terms() {
  ...
  useSeo({ title: t.meta.terms.title, description: t.meta.terms.description });
  useReveal([locale]);

  return (
    <div className="pt-32 pb-24 md:pt-40 md:pb-32">
      <div className="container max-w-3xl">
        <h1 className="reveal font-display text-4xl font-extrabold tracking-tight text-foreground">{t.legal.termsTitle}</h1>
